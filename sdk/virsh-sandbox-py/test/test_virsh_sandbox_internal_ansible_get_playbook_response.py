...
class TestVirshSandboxInternalAnsibleGetPlaybookResponse(unittest.TestCase):
    """VirshSandboxInternalAnsibleGetPlaybookResponse unit test stubs"""
    ...
    def make_instance(
        ...
        """Test VirshSandboxInternalAnsibleGetPlaybookResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `VirshSandboxInternalAnsibleGetPlaybookResponse`
        """
        model = VirshSandboxInternalAnsibleGetPlaybookResponse()
        if include_optional:
    ...
    def testVirshSandboxInternalAnsibleGetPlaybookResponse(self):
        """Test VirshSandboxInternalAnsibleGetPlaybookResponse"""
