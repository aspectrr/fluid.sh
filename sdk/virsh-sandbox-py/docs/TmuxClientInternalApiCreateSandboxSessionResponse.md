...
json = "{}"
# create an instance of TmuxClientInternalApiCreateSandboxSessionResponse from a JSON string
tmux_client_internal_api_create_sandbox_session_response_instance = TmuxClientInternalApiCreateSandboxSessionResponse.from_json(json)
# print the JSON string representation of the object
print(TmuxClientInternalApiCreateSandboxSessionResponse.to_json())

# convert the object into a dict
tmux_client_internal_api_create_sandbox_session_response_dict = tmux_client_internal_api_create_sandbox_session_response_instance.to_dict()
# create an instance of TmuxClientInternalApiCreateSandboxSessionResponse from a dict
tmux_client_internal_api_create_sandbox_session_response_from_dict = TmuxClientInternalApiCreateSandboxSessionResponse.from_dict(tmux_client_internal_api_create_sandbox_session_response_dict)
```
