...
class TmuxClientInternalTypesCopyFileResponse(BaseModel):
    """
    TmuxClientInternalTypesCopyFileResponse
    """  # noqa: E501

    bytes_copied: Optional[StrictInt] = None
    copied: Optional[StrictBool] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "bytes_copied": obj.get("bytes_copied"),
                "copied": obj.get("copied"),
