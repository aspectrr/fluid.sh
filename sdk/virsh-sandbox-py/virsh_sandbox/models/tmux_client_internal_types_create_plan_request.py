...
class TmuxClientInternalTypesCreatePlanRequest(BaseModel):
    """
    ...
    steps: Optional[List[StrictStr]] = Field(
        default=None, description="Step descriptions"
    )
    __properties: ClassVar[List[str]] = ["description", "name", "steps"]
