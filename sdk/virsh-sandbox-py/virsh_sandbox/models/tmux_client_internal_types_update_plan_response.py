...
class TmuxClientInternalTypesUpdatePlanResponse(BaseModel):
    """
    TmuxClientInternalTypesUpdatePlanResponse
    """  # noqa: E501

    plan: Optional[TmuxClientInternalTypesPlan] = None
    plan_id: Optional[StrictStr] = None
    updated: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["plan", "plan_id", "updated"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "plan": TmuxClientInternalTypesPlan.from_dict(obj["plan"])
