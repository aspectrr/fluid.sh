...
class VirshSandboxInternalAnsibleUpdateTaskResponse(BaseModel):
    """
    VirshSandboxInternalAnsibleUpdateTaskResponse
    """  # noqa: E501

    task: Optional[VirshSandboxInternalStorePlaybookTask] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "task": VirshSandboxInternalStorePlaybookTask.from_dict(obj["task"])
