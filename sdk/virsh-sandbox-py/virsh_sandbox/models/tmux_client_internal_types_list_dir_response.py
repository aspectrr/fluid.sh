...
class TmuxClientInternalTypesListDirResponse(BaseModel):
    """
    TmuxClientInternalTypesListDirResponse
    """  # noqa: E501

    files: Optional[List[TmuxClientInternalTypesFileInfo]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "files": [
                    TmuxClientInternalTypesFileInfo.from_dict(_item)
                    for _item in obj["files"]
                ]
