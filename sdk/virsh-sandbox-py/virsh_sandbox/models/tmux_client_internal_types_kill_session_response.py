...
class TmuxClientInternalTypesKillSessionResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["session_name", "success"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"session_name": obj.get("session_name"), "success": obj.get("success")}
        )
        return _obj
