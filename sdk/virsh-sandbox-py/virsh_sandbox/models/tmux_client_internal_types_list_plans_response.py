...
class TmuxClientInternalTypesListPlansResponse(BaseModel):
    """
    TmuxClientInternalTypesListPlansResponse
    """  # noqa: E501

    plans: Optional[List[TmuxClientInternalTypesPlan]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "plans": [
                    TmuxClientInternalTypesPlan.from_dict(_item)
