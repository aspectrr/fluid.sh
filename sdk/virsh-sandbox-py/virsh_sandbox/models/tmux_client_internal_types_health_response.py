...
class TmuxClientInternalTypesHealthResponse(BaseModel):
    ...
    components: Optional[List[TmuxClientInternalTypesComponentHealth]] = None
    status: Optional[TmuxClientInternalTypesHealthStatus] = None
    uptime: Optional[StrictStr] = None
    version: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["components", "status", "uptime", "version"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "components": [
                    TmuxClientInternalTypesComponentHealth.from_dict(_item)
                    for _item in obj["components"]
                ]
