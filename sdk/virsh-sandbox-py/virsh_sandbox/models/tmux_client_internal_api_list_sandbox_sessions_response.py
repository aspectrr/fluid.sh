...
class TmuxClientInternalApiListSandboxSessionsResponse(BaseModel):
    """
    TmuxClientInternalApiListSandboxSessionsResponse
    """  # noqa: E501

    sessions: Optional[List[TmuxClientInternalApiSandboxSessionInfo]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "sessions": [
                    TmuxClientInternalApiSandboxSessionInfo.from_dict(_item)
