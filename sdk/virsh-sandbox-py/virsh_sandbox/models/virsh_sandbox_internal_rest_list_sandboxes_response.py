...
class VirshSandboxInternalRestListSandboxesResponse(BaseModel):
    """
    VirshSandboxInternalRestListSandboxesResponse
    """  # noqa: E501

    sandboxes: Optional[List[VirshSandboxInternalRestSandboxInfo]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "sandboxes": [
                    VirshSandboxInternalRestSandboxInfo.from_dict(_item)
