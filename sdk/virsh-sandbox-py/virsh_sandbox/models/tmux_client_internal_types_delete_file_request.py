...
class TmuxClientInternalTypesDeleteFileRequest(BaseModel):
    """
    TmuxClientInternalTypesDeleteFileRequest
    """  # noqa: E501

    path: Optional[StrictStr] = None
    recursive: Optional[StrictBool] = Field(default=None, description="For directories")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"path": obj.get("path"), "recursive": obj.get("recursive")}
        )
        return _obj
