...
class VirshSandboxInternalRestListSandboxCommandsResponse(BaseModel):
    """
    VirshSandboxInternalRestListSandboxCommandsResponse
    """  # noqa: E501

    commands: Optional[List[VirshSandboxInternalStoreCommand]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "commands": [
                    VirshSandboxInternalStoreCommand.from_dict(_item)
