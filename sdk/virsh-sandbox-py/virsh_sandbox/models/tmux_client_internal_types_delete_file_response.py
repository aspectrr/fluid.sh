...
class TmuxClientInternalTypesDeleteFileResponse(BaseModel):
    """
    ...
    was_dir: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["deleted", "path", "was_dir"]
