...
class TmuxClientInternalTypesSwitchPaneResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["pane_id", "switched"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"pane_id": obj.get("pane_id"), "switched": obj.get("switched")}
        )
        return _obj
