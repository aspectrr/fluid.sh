...
class TmuxClientInternalTypesListApprovalsResponse(BaseModel):
    """
    TmuxClientInternalTypesListApprovalsResponse
    """

    pending: Optional[List[TmuxClientInternalTypesPendingApproval]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "pending": [
                    TmuxClientInternalTypesPendingApproval.from_dict(_item)
                    for _item in obj["pending"]
                ]
