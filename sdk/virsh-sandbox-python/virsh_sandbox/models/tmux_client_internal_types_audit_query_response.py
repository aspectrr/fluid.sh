...
class TmuxClientInternalTypesAuditQueryResponse(BaseModel):
    ...
    entries: Optional[List[TmuxClientInternalTypesAuditEntry]] = None
    has_more: Optional[StrictBool] = None
    total_count: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["entries", "has_more", "total_count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "entries": [
                    TmuxClientInternalTypesAuditEntry.from_dict(_item)
