...
class TmuxClientInternalTypesSessionInfo(BaseModel):
    """
    ...
    last_pane_x: Optional[StrictInt] = None
    last_pane_y: Optional[StrictInt] = None
    name: Optional[StrictStr] = None
    windows: Optional[StrictInt] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "id": obj.get("id"),
                "last_pane_x": obj.get("last_pane_x"),
                "last_pane_y": obj.get("last_pane_y"),
                "name": obj.get("name"),
