...
export default function TmuxSessionDetailsPage() {
  ...
  if (isError || !session) {
    return (
      <main className="container mx-auto px-4 py-8">
        <Button variant="ghost" className="mb-6" onClick={() => router.push('/tmux')}>
      ...
      <div className="grid gap-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Basic details about this Tmux session</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <p className="text-muted-foreground text-sm font-medium">Number of Panes</p>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Recent commands executed in this session</CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            {session.commands.map((item, index) => (
              <div key={index} className="space-y-2">
                ...
                <div>
                  <p className="text-muted-foreground mb-1 text-sm font-medium">Output</p>
                  <div className="bg-muted rounded-md p-3">
